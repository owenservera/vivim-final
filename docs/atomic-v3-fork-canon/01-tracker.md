...
- [x] 8.12 (v3:7.12) — Autonomous integration with canvases → `docs/atomic-v3-fork-canon/phase-08-autonomous-orch/7.12-canvas-integration.md` — EXISTS via canvas capability-bridge + agentic-loop.ts
