...
# Phase 0: Kernel Core — Phase Index

**Units:** 9 | **Status:** [ ] pending | **Domain:** Kernel self-understanding foundation

## Overview

Phase 0 is the foundation. It installs a self-understanding layer so every subsequent engine
registers with the kernel at construction time. The system becomes self-aware.

## Units

| ID | Name | Priority | Status |
|----|------|----------|--------|
| 0.0 | CapabilityEventBus Upgrade | CRITICAL | [ ] |
| 0.1 | KernelRegistry | CRITICAL | [ ] |
| 0.2 | KernelContext | CRITICAL | [ ] |
| 0.3 | KernelTracer | HIGH | [ ] |
| 0.4 | KernelProvenance | HIGH | [ ] |
| 0.5 | Prisma Schema Migration | CRITICAL | [ ] |
| 0.6 | KernelBootstrap | CRITICAL | [ ] |
| 0.6a | Server Bootstrap Refactor | CRITICAL | [ ] |
| 0.7 | Test Infrastructure Consolidation | HIGH | [ ] |
...
1. **Event bus first** — capabilityEventBus must support error isolation before kernel can wire
2. **Registry → Context → Tracer** — Each layer builds on the previous
3. **Schema migration** — 4 new kernel tables (KernelRegistry, KernelTracer, KernelProvenance, KernelConfig)
4. **Bootstrap integration** — Kernel wires into createServerWithEngines as step 0

## Spec References

- 0.0: `docs/atomic-v5/phase-00-surgical-edit/0.0-capability-event-bus-upgrade.md`
- 0.1: `docs/atomic-v5/phase-00-kernel-core/0.1-kernel-registry.md`
- 0.2: `docs/atomic-v5/phase-00-kernel-core/0.2-kernel-context.md`
- 0.3: `docs/atomic-v5/phase-00-kernel-core/0.3-kernel-tracer.md`
- 0.4: `docs/atomic-v5/phase-00-kernel-core/0.4-kernel-provenance.md`
- 0.5: `docs/atomic-v5/phase-00-surgical-edit/0.5-prisma-schema-migration.md`
- 0.6: `docs/atomic-v5/phase-00-kernel-core/0.6-kernel-bootstrap.md`
- 0.6a: `docs/atomic-v5/phase-00-surgical-edit/0.6a-server-bootstrap-refactor.md`
- 0.7: `docs/atomic-v5/phase-00-surgical-edit/0.7-test-infrastructure.md`

## Completion Criteria

- [ ] All 9 units marked [x] in tracker
- [ ] `KernelContext` available to all subsequent engines
- [ ] Every engine registers with kernel at construction time
- [ ] Schema migration applied and kernel tables exist
