...
| Fork ID | v5 ID | Phase | Source Spec Path |
|---------|-------|-------|------------------|
| 0.0 | 0.0 | 0 | `docs/atomic-v5/phase-00-surgical-edit/0.0-capability-event-bus-upgrade.md` |
| 0.1 | 0.1 | 0 | `docs/atomic-v5/phase-00-kernel-core/0.1-kernel-registry.md` |
| 0.2 | 0.2 | 0 | `docs/atomic-v5/phase-00-kernel-core/0.2-kernel-context.md` |
| 0.3 | 0.3 | 0 | `docs/atomic-v5/phase-00-kernel-core/0.3-kernel-tracer.md` |
| 0.4 | 0.4 | 0 | `docs/atomic-v5/phase-00-kernel-core/0.4-kernel-provenance.md` |
| 0.5 | 0.5 | 0 | `docs/atomic-v5/phase-00-surgical-edit/0.5-prisma-schema-migration.md` |
| 0.6 | 0.6 | 0 | `docs/atomic-v5/phase-00-kernel-core/0.6-kernel-bootstrap.md` |
| 0.6a | 0.6a | 0 | `docs/atomic-v5/phase-00-surgical-edit/0.6a-server-bootstrap-refactor.md` |
| 0.7 | 0.7 | 0 | `docs/atomic-v5/phase-00-surgical-edit/0.7-test-infrastructure.md` |

### Phase 1-14: CDP/Chrome (same as v4)
...
### Phase 15-16: Kernel Oracle + Surfaces

| Fork ID | v5 ID | Phase | Source Spec Path |
|---------|-------|-------|------------------|
| 15.1 | 15.1 | 15 | `docs/atomic-v5/phase-15-kernel-oracle/15.1-oracle-query.md` |
| 15.2 | 15.2 | 15 | `docs/atomic-v5/phase-15-kernel-oracle/15.2-oracle-diagnostic.md` |
| 15.3 | 15.3 | 15 | `docs/atomic-v5/phase-15-kernel-oracle/15.3-oracle-actuator.md` |
| 15.4 | 15.4 | 15 | `docs/atomic-v5/phase-15-kernel-oracle/15.4-oracle-event-stream.md` |
| 16.1 | 16.1 | 16 | `docs/atomic-v5/phase-16-kernel-surfaces/16.1-kernel-rest.md` |
| 16.2 | 16.2 | 16 | `docs/atomic-v5/phase-16-kernel-surfaces/16.2-kernel-mcp.md` |
| 16.3 | 16.3 | 16 | `docs/atomic-v5/phase-16-kernel-surfaces/16.3-kernel-cli.md` |
| 16.4 | 16.4 | 16 | `docs/atomic-v5/phase-16-kernel-surfaces/16.4-kernel-frontend.md` |
| 16.5 | 16.5 | 16 | `docs/atomic-v5/phase-00-surgical-edit/16.5-mcp-server-integration.md` |
| 16.6 | 16.6 | 16 | `docs/atomic-v5/phase-00-surgical-edit/16.6-cli-kernel-commands.md` |

## Summary

| Phase | Units | Source |
|-------|-------|--------|
| 0 | 10 | v5 Phase 0 (kernel) |
| 1 | 7 | v4 Phase 1 |
| 2 | 8 | v4 Phase 2 |
| 3 | 6 | v4 Phase 3 |
| 4 | 5 | v4 Phase 4 |
...
| 13 | 3 | v4 Phase 13 |
| 14 | 4 | v4 Phase 14 |
| 15 | 4 | v5 Phase 15 (oracle) |
| 16 | 6 | v5 Phase 16 (surfaces) |
| **Total** | **91** | |

**Note:** Fork IDs match original IDs exactly (1:1 mapping). No renumbering needed.
