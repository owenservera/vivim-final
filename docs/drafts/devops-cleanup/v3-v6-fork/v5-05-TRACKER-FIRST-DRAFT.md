# vivim-final v5-fork-canon — Atomic Tracker (Kernel-First + CDP)

**Total units:** 90 | **Done:** 0 | **Blocked:** 0 | **Pending:** 90

> The authoritative source of truth for v5-fork-canon implementation progress.
...
> store, capability, and route registers with the kernel at construction time.
...
> **CDP/Chrome + Kernel:** This fork combines CDP browser control with kernel self-healing.
> v4 is the CDP-only subset (71 units). v5 adds kernel + oracle + surfaces (20 more units).

## Phase 0: Kernel Core (9 units)
...
- [ ] 16.5 — MCP Server Kernel Integration: register kernel tools → `docs/atomic-v5/phase-00-surgical-edit/16.5-mcp-server-integration.md`
