...
- Reports older than 6 months must be re-verified within 3 months
- Stale reports go to `stale/` with replacement note
- Gate check (A7) enforces freshness before `in_progress` on CREATE units
