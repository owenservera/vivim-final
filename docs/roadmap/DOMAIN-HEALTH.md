...
**Generated:** 2026-07-21T00:04:19.463Z
...
| configuration | 1 | 1 | 0 | 100% | Mixed file: src/config.ts; Interface not implemented: TunableMeta |
...
| cli | 8 | 8 | 0 | 100% | Interface not implemented: SetupClientOptions; Interface not implemented: OpenCodeClientOptions |
...
- **general:** 383 gaps
- **storage:** 101 gaps
- **capability-system:** 41 gaps
- **chrome-management:** 36 gaps
- **provider-routing:** 32 gaps
- **session-state:** 12 gaps
- **configuration:** 11 gaps
- **api-server:** 10 gaps
