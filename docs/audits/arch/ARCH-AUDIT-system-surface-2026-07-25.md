# Architecture Audit — system-wide (surface) — 2026-07-25
...
- **Module edges:** 903
- **Cycles:** 5
- **Layer histogram:** L0=44  L1=27  L2=7  L3=136  L4=6  L5=60
- **Top hubs:** index(92)  storage/contracts(85)  server/index(83)  errors(76)  ids(52)  engines/capability-event-bus(41)  engines/chrome-governor(40)  engines/unified-registry(34)

## Executive Summary

- **Risk score:** Medium (M)
- **Priorities:** P0: 0  P1: 56  P2: 0  P3: 0
- **Total findings:** 56
...
### [P1] AR-0001 — Cyclic module dependency (18 modules)
- **Dimension:** cycles
- **Location:** `src/router/router:0`
- **Evidence:** `cycle: router/router -> engines/provider-mux -> engines/capability-resolution -> engines/mirror-engine -> engines/cdp-capability-registrar -> engines/sandbox-runner -> engines/stream-parser -> engines/harness -> engines/humanized-interaction -> engines/composer-typing -> engines/cdp-watchdog -> engines/capability-snapshot -> engines/anti-detection -> executor/fleet-limiter -> executor/fleet-supervisor -> engines/chrome-governor -> engines/browser-automation -> storage/contracts -> router/router`
...
- **Dimension:** cycles
- **Location:** `src/server/agent-canvas-router:0`
- **Evidence:** `cycle: server/agent-canvas-router -> server/canvas-router -> server/setup-router -> server/knowledge-router -> server/conversation-router -> server/capability-router -> server/index -> cli/index -> server/agent-canvas-router`
- **Impact:** Cycles complicate reasoning, break lazy init, and make refactoring risky.
- **Fix Instructions:**
  - Introduce an interface/contract module that the cycle participants depend on, or invert one of the dependency directions.
  - Steps:
...
### [P1] AR-0017 — Upward dependency: engines/chrome-governor -> lib/logger
- **Dimension:** layering
- **Location:** `src/engines/chrome-governor:0`
- **Evidence:** `edge engines/chrome-governor -> lib/logger (layers 1 -> 3)`
- **Impact:** Upward dependencies invert the intended layering and couple foundation modules to surface concerns.
- **Fix Instructions:**
...
### [P1] AR-0018 — Upward dependency: engines/chrome-governor -> engines/anti-detection
- **Dimension:** layering
- **Location:** `src/engines/chrome-governor:0`
- **Evidence:** `edge engines/chrome-governor -> engines/anti-detection (layers 1 -> 3)`
- **Impact:** Upward dependencies invert the intended layering and couple foundation modules to surface concerns.
- **Fix Instructions:**
  - Move the shared responsibility into a lower layer, or depend on a contract exposed by `engines/anti-detection` rather than `engines/anti-detection` itself.
  - Steps:
    - Identify the symbols imported from the higher layer.
    - Decide whether they belong in a shared lower-layer contract.
    - Re-point the import; otherwise accept the edge as an explicit policy exception.
...
### [P1] AR-0019 — Upward dependency: engines/chrome-governor -> engines/browser-automation
- **Dimension:** layering
- **Location:** `src/engines/chrome-governor:0`
...
### [P1] AR-0020 — Upward dependency: engines/chrome-governor -> engines/capability-snapshot
- **Dimension:** layering
- **Location:** `src/engines/chrome-governor:0`
...
### [P1] AR-0021 — Upward dependency: engines/chrome-governor -> engines/cdp-watchdog
- **Dimension:** layering
- **Location:** `src/engines/chrome-governor:0`
- **Evidence:** `edge engines/chrome-governor -> engines/cdp-watchdog (layers 1 -> 3)`
- **Impact:** Upward dependencies invert the intended layering and couple foundation modules to surface concerns.
- **Fix Instructions:**
  - Move the shared responsibility into a lower layer, or depend on a contract exposed by `engines/cdp-watchdog` rather than `engines/cdp-watchdog` itself.
  - Steps:
    - Identify the symbols imported from the higher layer.
    - Decide whether they belong in a shared lower-layer contract.
    - Re-point the import; otherwise accept the edge as an explicit policy exception.
...
### [P1] AR-0022 — Upward dependency: engines/chrome-governor -> engines/composer-typing
- **Dimension:** layering
- **Location:** `src/engines/chrome-governor:0`
...
### [P1] AR-0023 — Upward dependency: engines/chrome-governor -> engines/harness
- **Dimension:** layering
- **Location:** `src/engines/chrome-governor:0`
...
### [P1] AR-0024 — Upward dependency: engines/config-universal-surface -> engines/telemetry-aggregator
- **Dimension:** layering
...
### [P1] AR-0025 — Upward dependency: engines/kernel -> engines/capability-event-bus
- **Dimension:** layering
- **Location:** `src/engines/kernel:0`
...
### [P1] AR-0026 — Upward dependency: engines/kernel -> engines/config-manager
- **Dimension:** layering
- **Location:** `src/engines/kernel:0`
...
### [P1] AR-0027 — Upward dependency: engines/kernel -> engines/conversation-manager
- **Dimension:** layering
- **Location:** `src/engines/kernel:0`
...
### [P1] AR-0028 — Upward dependency: engines/kernel -> engines/nlcl
- **Dimension:** layering
- **Location:** `src/engines/kernel:0`
...
### [P1] AR-0029 — Upward dependency: engines/kernel -> engines/unified-registry
- **Dimension:** layering
- **Location:** `src/engines/kernel:0`
...
### [P1] AR-0030 — Upward dependency: engines/kernel -> lib/logger
- **Dimension:** layering
- **Location:** `src/engines/kernel:0`
...
### [P1] AR-0031 — Upward dependency: engines/live-capability-registry -> engines/mcp-client-adapter
- **Dimension:** layering
...
### [P1] AR-0032 — Upward dependency: engines/live-capability-registry -> engines/telemetry-audit
- **Dimension:** layering
- **Location:** `src/engines/live-capability-registry:0`
...
### [P1] AR-0033 — Upward dependency: engines/opencode -> engines/nlcl
- **Dimension:** layering
...
### [P1] AR-0034 — Upward dependency: engines/provider-discovery -> engines/capability-event-bus
- **Dimension:** layering
...
### [P1] AR-0035 — Upward dependency: engines/provider-discovery -> engines/capability-shape-registry
- **Dimension:** layering
- **Location:** `src/engines/provider-discovery:0`
...
### [P1] AR-0036 — Upward dependency: engines/provider-discovery -> engines/manifest-inference
- **Dimension:** layering
- **Location:** `src/engines/provider-discovery:0`
...
### [P1] AR-0037 — Upward dependency: engines/provider-discovery -> engines/stream-align
- **Dimension:** layering
- **Location:** `src/engines/provider-discovery:0`
...
### [P1] AR-0038 — Upward dependency: engines/provider-health -> engines/capability-event-bus
- **Dimension:** layering
...
### [P1] AR-0039 — Upward dependency: engines/provider-mux -> router/router
- **Dimension:** layering
...
### [P1] AR-0040 — Upward dependency: engines/provider-mux -> engines/capability-event-bus
- **Dimension:** layering
- **Location:** `src/engines/provider-mux:0`
...
### [P1] AR-0041 — Upward dependency: engines/provider-mux -> engines/messaging-archetypes
- **Dimension:** layering
- **Location:** `src/engines/provider-mux:0`
...
### [P1] AR-0042 — Upward dependency: engines/provider-registrar -> engines/stream-align
- **Dimension:** layering
...
### [P1] AR-0043 — Upward dependency: engines/send-capability -> engines/unified-registry
- **Dimension:** layering
...
### [P1] AR-0044 — Upward dependency: schema/chrome -> executor/chrome-instance-profile
- **Dimension:** layering
...
### [P1] AR-0045 — Upward dependency: schema/chrome -> executor/slave-states
- **Dimension:** layering
- **Location:** `src/schema/chrome:0`
...
### [P1] AR-0046 — Upward dependency: storage/contracts -> engines/browser-automation
- **Dimension:** layering
...
### [P1] AR-0047 — Upward dependency: storage/contracts -> canvas/types
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0048 — Upward dependency: storage/contracts -> executor/slave-states
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0049 — Upward dependency: storage/contracts -> engines/intent-decomposer
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0050 — Upward dependency: storage/contracts -> engines/mirror-engine
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0051 — Upward dependency: storage/contracts -> engines/provider-mux
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0052 — Upward dependency: storage/contracts -> engines/sandbox-runner
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0053 — Upward dependency: storage/db -> lib/logger
- **Dimension:** layering
- **Location:** `src/storage/db:0`
- **Evidence:** `edge storage/db -> lib/logger (layers 0 -> 3)`
- **Impact:** Upward dependencies invert the intended layering and couple foundation modules to surface concerns.
- **Fix Instructions:**
  - Move the shared responsibility into a lower layer, or depend on a contract exposed by `lib/logger` rather than `lib/logger` itself.
  - Steps:
...
### [P1] AR-0054 — Upward dependency: storage/db -> storage/impl
- **Dimension:** layering
- **Location:** `src/storage/db:0`
...
### [P1] AR-0055 — Upward dependency: storage/impl -> engines/harness
- **Dimension:** layering
...
### [P1] AR-0056 — Upward dependency: storage/prisma -> lib/logger
- **Dimension:** layering
- **Location:** `src/storage/prisma:0`
- **Evidence:** `edge storage/prisma -> lib/logger (layers 0 -> 3)`
- **Impact:** Upward dependencies invert the intended layering and couple foundation modules to surface concerns.
- **Fix Instructions:**
  - Move the shared responsibility into a lower layer, or depend on a contract exposed by `lib/logger` rather than `lib/logger` itself.
  - Steps:
...
| AR-0004 | P1 | cycles | `src/server/agent-canvas-router:0` | L | no |
...
| AR-0021 | P1 | layering | `src/engines/chrome-governor:0` | M | no |
| AR-0022 | P1 | layering | `src/engines/chrome-governor:0` | M | no |
| AR-0023 | P1 | layering | `src/engines/chrome-governor:0` | M | no |
| AR-0024 | P1 | layering | `src/engines/config-universal-surface:0` | M | no |
...
| AR-0028 | P1 | layering | `src/engines/kernel:0` | M | no |
| AR-0029 | P1 | layering | `src/engines/kernel:0` | M | no |
| AR-0030 | P1 | layering | `src/engines/kernel:0` | M | no |
| AR-0031 | P1 | layering | `src/engines/live-capability-registry:0` | M | no |
| AR-0032 | P1 | layering | `src/engines/live-capability-registry:0` | M | no |
| AR-0033 | P1 | layering | `src/engines/opencode:0` | M | no |
| AR-0034 | P1 | layering | `src/engines/provider-discovery:0` | M | no |
| AR-0035 | P1 | layering | `src/engines/provider-discovery:0` | M | no |
| AR-0036 | P1 | layering | `src/engines/provider-discovery:0` | M | no |
| AR-0037 | P1 | layering | `src/engines/provider-discovery:0` | M | no |
| AR-0038 | P1 | layering | `src/engines/provider-health:0` | M | no |
| AR-0039 | P1 | layering | `src/engines/provider-mux:0` | M | no |
| AR-0040 | P1 | layering | `src/engines/provider-mux:0` | M | no |
| AR-0041 | P1 | layering | `src/engines/provider-mux:0` | M | no |
| AR-0042 | P1 | layering | `src/engines/provider-registrar:0` | M | no |
| AR-0043 | P1 | layering | `src/engines/send-capability:0` | M | no |
| AR-0044 | P1 | layering | `src/schema/chrome:0` | M | no |
| AR-0045 | P1 | layering | `src/schema/chrome:0` | M | no |
...
| AR-0050 | P1 | layering | `src/storage/contracts:0` | M | no |
| AR-0051 | P1 | layering | `src/storage/contracts:0` | M | no |
| AR-0052 | P1 | layering | `src/storage/contracts:0` | M | no |
| AR-0053 | P1 | layering | `src/storage/db:0` | M | no |
| AR-0054 | P1 | layering | `src/storage/db:0` | M | no |
| AR-0055 | P1 | layering | `src/storage/impl:0` | M | no |
| AR-0056 | P1 | layering | `src/storage/prisma:0` | M | no |
