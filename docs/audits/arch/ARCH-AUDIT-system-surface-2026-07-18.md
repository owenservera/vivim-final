# Architecture Audit — system-wide (surface) — 2026-07-18
...
- **Module edges:** 749
- **Cycles:** 5
- **Layer histogram:** L0=41  L1=25  L2=7  L3=104  L4=6  L5=58
- **Top hubs:** index(76)  storage/contracts(72)  server/index(67)  errors(60)  ids(47)  engines/capability-event-bus(35)  engines/chrome-governor(33)  engines/unified-registry(30)

## Executive Summary

- **Risk score:** Medium (M)
- **Priorities:** P0: 0  P1: 44  P2: 0  P3: 0
- **Total findings:** 44
...
### [P1] AR-0001 — Cyclic module dependency (13 modules)
- **Dimension:** cycles
- **Location:** `src/engines/sandbox-runner:0`
- **Evidence:** `cycle: engines/sandbox-runner -> router/router -> engines/provider-mux -> engines/capability-resolution -> engines/mirror-engine -> engines/composer-typing -> engines/cdp-capability-registrar -> engines/harness -> engines/capability-snapshot -> executor/fleet-supervisor -> engines/chrome-governor -> engines/browser-automation -> storage/contracts -> engines/sandbox-runner`
...
### [P1] AR-0003 — Cyclic module dependency (15 modules)
- **Dimension:** cycles
- **Location:** `src/engines/stream-block-store:0`
- **Evidence:** `cycle: engines/stream-block-store -> __generated__/provider-protocol -> __generated__/provider-protocol.dev -> engines/provider-protocol-generator -> engines/provider-protocol-loader -> config/provider-registry -> engines/provider-selectors -> engines/conversation-manager -> engines/nlcl -> engines/autonomous-replay -> engines/autonomous-execution -> engines/execution-policy -> storage/impl -> storage/prisma -> storage/db -> engines/stream-block-store`
- **Impact:** Cycles complicate reasoning, break lazy init, and make refactoring risky.
- **Fix Instructions:**
  - Introduce an interface/contract module that the cycle participants depend on, or invert one of the dependency directions.
  - Steps:
...
### [P1] AR-0004 — Cyclic module dependency (7 modules)
- **Dimension:** cycles
- **Location:** `src/server/canvas-router:0`
- **Evidence:** `cycle: server/canvas-router -> server/setup-router -> server/knowledge-router -> server/conversation-router -> server/capability-router -> server/index -> cli/index -> server/canvas-router`
- **Impact:** Cycles complicate reasoning, break lazy init, and make refactoring risky.
- **Fix Instructions:**
  - Introduce an interface/contract module that the cycle participants depend on, or invert one of the dependency directions.
  - Steps:
...
### [P1] AR-0008 — Upward dependency: config/provider-registry -> engines/provider-protocol-generator
- **Dimension:** layering
- **Location:** `src/config/provider-registry:0`
- **Evidence:** `edge config/provider-registry -> engines/provider-protocol-generator (layers 0 -> 3)`
- **Impact:** Upward dependencies invert the intended layering and couple foundation modules to surface concerns.
- **Fix Instructions:**
  - Move the shared responsibility into a lower layer, or depend on a contract exposed by `engines/provider-protocol-generator` rather than `engines/provider-protocol-generator` itself.
  - Steps:
    - Identify the symbols imported from the higher layer.
    - Decide whether they belong in a shared lower-layer contract.
    - Re-point the import; otherwise accept the edge as an explicit policy exception.
...
### [P1] AR-0013 — Upward dependency: engines/capability -> engines/conversation-manager
- **Dimension:** layering
...
### [P1] AR-0014 — Upward dependency: engines/cdp-capability-registrar -> engines/harness
- **Dimension:** layering
...
### [P1] AR-0015 — Upward dependency: engines/chrome-governor -> engines/browser-automation
- **Dimension:** layering
...
### [P1] AR-0016 — Upward dependency: engines/chrome-governor -> engines/capability-snapshot
- **Dimension:** layering
- **Location:** `src/engines/chrome-governor:0`
...
### [P1] AR-0017 — Upward dependency: engines/chrome-governor -> engines/harness
- **Dimension:** layering
- **Location:** `src/engines/chrome-governor:0`
...
### [P1] AR-0018 — Upward dependency: engines/chrome-governor -> engines/composer-typing
- **Dimension:** layering
- **Location:** `src/engines/chrome-governor:0`
...
### [P1] AR-0019 — Upward dependency: engines/config-universal-surface -> engines/telemetry-aggregator
- **Dimension:** layering
...
### [P1] AR-0020 — Upward dependency: engines/kernel -> engines/capability-event-bus
- **Dimension:** layering
...
### [P1] AR-0021 — Upward dependency: engines/kernel -> engines/config-manager
- **Dimension:** layering
- **Location:** `src/engines/kernel:0`
...
### [P1] AR-0022 — Upward dependency: engines/kernel -> engines/conversation-manager
- **Dimension:** layering
- **Location:** `src/engines/kernel:0`
...
### [P1] AR-0023 — Upward dependency: engines/kernel -> engines/nlcl
- **Dimension:** layering
- **Location:** `src/engines/kernel:0`
...
### [P1] AR-0024 — Upward dependency: engines/kernel -> engines/unified-registry
- **Dimension:** layering
- **Location:** `src/engines/kernel:0`
...
### [P1] AR-0025 — Upward dependency: engines/provider-discovery -> engines/capability-event-bus
- **Dimension:** layering
...
### [P1] AR-0026 — Upward dependency: engines/provider-discovery -> engines/capability-shape-registry
- **Dimension:** layering
- **Location:** `src/engines/provider-discovery:0`
...
### [P1] AR-0027 — Upward dependency: engines/provider-discovery -> engines/manifest-inference
- **Dimension:** layering
- **Location:** `src/engines/provider-discovery:0`
...
### [P1] AR-0028 — Upward dependency: engines/provider-health -> engines/capability-event-bus
- **Dimension:** layering
...
### [P1] AR-0029 — Upward dependency: engines/provider-mux -> router/router
- **Dimension:** layering
...
### [P1] AR-0030 — Upward dependency: engines/provider-mux -> engines/capability-event-bus
- **Dimension:** layering
- **Location:** `src/engines/provider-mux:0`
...
### [P1] AR-0031 — Upward dependency: engines/provider-mux -> engines/messaging-archetypes
- **Dimension:** layering
- **Location:** `src/engines/provider-mux:0`
...
### [P1] AR-0032 — Upward dependency: engines/provider-registrar -> engines/stream-align
- **Dimension:** layering
...
### [P1] AR-0033 — Upward dependency: engines/send-capability -> engines/unified-registry
- **Dimension:** layering
...
### [P1] AR-0034 — Upward dependency: schema/chrome -> executor/chrome-instance-profile
- **Dimension:** layering
...
### [P1] AR-0035 — Upward dependency: schema/chrome -> executor/slave-states
- **Dimension:** layering
- **Location:** `src/schema/chrome:0`
...
### [P1] AR-0036 — Upward dependency: storage/contracts -> engines/browser-automation
- **Dimension:** layering
...
### [P1] AR-0037 — Upward dependency: storage/contracts -> canvas/types
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0038 — Upward dependency: storage/contracts -> executor/slave-states
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0039 — Upward dependency: storage/contracts -> engines/intent-decomposer
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0040 — Upward dependency: storage/contracts -> engines/mirror-engine
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0041 — Upward dependency: storage/contracts -> engines/provider-mux
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0042 — Upward dependency: storage/contracts -> engines/sandbox-runner
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0043 — Upward dependency: storage/db -> storage/impl
- **Dimension:** layering
...
### [P1] AR-0044 — Upward dependency: storage/impl -> engines/harness
- **Dimension:** layering
...
| AR-0008 | P1 | layering | `src/config/provider-registry:0` | M | no |
...
| AR-0013 | P1 | layering | `src/engines/capability:0` | M | no |
| AR-0014 | P1 | layering | `src/engines/cdp-capability-registrar:0` | M | no |
| AR-0015 | P1 | layering | `src/engines/chrome-governor:0` | M | no |
| AR-0016 | P1 | layering | `src/engines/chrome-governor:0` | M | no |
| AR-0017 | P1 | layering | `src/engines/chrome-governor:0` | M | no |
| AR-0018 | P1 | layering | `src/engines/chrome-governor:0` | M | no |
| AR-0019 | P1 | layering | `src/engines/config-universal-surface:0` | M | no |
| AR-0020 | P1 | layering | `src/engines/kernel:0` | M | no |
| AR-0021 | P1 | layering | `src/engines/kernel:0` | M | no |
...
| AR-0025 | P1 | layering | `src/engines/provider-discovery:0` | M | no |
| AR-0026 | P1 | layering | `src/engines/provider-discovery:0` | M | no |
| AR-0027 | P1 | layering | `src/engines/provider-discovery:0` | M | no |
| AR-0028 | P1 | layering | `src/engines/provider-health:0` | M | no |
| AR-0029 | P1 | layering | `src/engines/provider-mux:0` | M | no |
| AR-0030 | P1 | layering | `src/engines/provider-mux:0` | M | no |
| AR-0031 | P1 | layering | `src/engines/provider-mux:0` | M | no |
| AR-0032 | P1 | layering | `src/engines/provider-registrar:0` | M | no |
| AR-0033 | P1 | layering | `src/engines/send-capability:0` | M | no |
| AR-0034 | P1 | layering | `src/schema/chrome:0` | M | no |
| AR-0035 | P1 | layering | `src/schema/chrome:0` | M | no |
...
| AR-0039 | P1 | layering | `src/storage/contracts:0` | M | no |
| AR-0040 | P1 | layering | `src/storage/contracts:0` | M | no |
| AR-0041 | P1 | layering | `src/storage/contracts:0` | M | no |
| AR-0042 | P1 | layering | `src/storage/contracts:0` | M | no |
| AR-0043 | P1 | layering | `src/storage/db:0` | M | no |
| AR-0044 | P1 | layering | `src/storage/impl:0` | M | no |
