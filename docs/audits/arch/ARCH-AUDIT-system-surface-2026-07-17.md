# Architecture Audit — system-wide (surface) — 2026-07-17
...
- **Module edges:** 681
- **Cycles:** 6
- **Layer histogram:** L0=27  L1=25  L2=7  L3=95  L4=6  L5=57
- **Top hubs:** index(75)  storage/contracts(65)  server/index(59)  errors(57)  ids(45)  engines/capability-event-bus(35)  engines/unified-registry(30)  engines/chrome-governor(28)

## Executive Summary

- **Risk score:** Medium (M)
- **Priorities:** P0: 0  P1: 38  P2: 0  P3: 0
- **Total findings:** 38
...
### [P1] AR-0005 — Cyclic module dependency (7 modules)
- **Dimension:** cycles
...
### [P1] AR-0007 — Upward dependency: automation/automation-router -> server/response
- **Dimension:** layering
...
### [P1] AR-0008 — Upward dependency: engines/autonomous-execution -> engines/nlcl
- **Dimension:** layering
...
### [P1] AR-0009 — Upward dependency: engines/capability-bootstrap -> cli/discovery-stack
- **Dimension:** layering
...
### [P1] AR-0010 — Upward dependency: engines/capability-bootstrap -> engines/nlcl
- **Dimension:** layering
- **Location:** `src/engines/capability-bootstrap:0`
...
### [P1] AR-0011 — Upward dependency: engines/capability -> engines/conversation-manager
- **Dimension:** layering
...
### [P1] AR-0012 — Upward dependency: engines/cdp-capability-registrar -> engines/harness
- **Dimension:** layering
- **Location:** `src/engines/cdp-capability-registrar:0`
...
### [P1] AR-0013 — Upward dependency: engines/chrome-governor -> engines/composer-typing
- **Dimension:** layering
...
### [P1] AR-0014 — Upward dependency: engines/config-universal-surface -> engines/telemetry-aggregator
- **Dimension:** layering
...
### [P1] AR-0024 — Upward dependency: engines/provider-mux -> router/router
- **Dimension:** layering
...
### [P1] AR-0025 — Upward dependency: engines/provider-mux -> engines/capability-event-bus
- **Dimension:** layering
- **Location:** `src/engines/provider-mux:0`
...
### [P1] AR-0026 — Upward dependency: engines/provider-mux -> engines/messaging-archetypes
- **Dimension:** layering
- **Location:** `src/engines/provider-mux:0`
...
### [P1] AR-0027 — Upward dependency: engines/provider-registrar -> engines/stream-align
- **Dimension:** layering
...
### [P1] AR-0028 — Upward dependency: engines/send-capability -> engines/unified-registry
- **Dimension:** layering
...
### [P1] AR-0029 — Upward dependency: schema/chrome -> executor/chrome-instance-profile
- **Dimension:** layering
...
### [P1] AR-0030 — Upward dependency: schema/chrome -> executor/slave-states
- **Dimension:** layering
- **Location:** `src/schema/chrome:0`
...
### [P1] AR-0031 — Upward dependency: storage/contracts -> canvas/types
- **Dimension:** layering
...
### [P1] AR-0032 — Upward dependency: storage/contracts -> executor/slave-states
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0033 — Upward dependency: storage/contracts -> engines/intent-decomposer
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0034 — Upward dependency: storage/contracts -> engines/mirror-engine
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0035 — Upward dependency: storage/contracts -> engines/provider-mux
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0036 — Upward dependency: storage/contracts -> engines/sandbox-runner
- **Dimension:** layering
- **Location:** `src/storage/contracts:0`
...
### [P1] AR-0037 — Upward dependency: storage/db -> storage/impl
- **Dimension:** layering
...
### [P1] AR-0038 — Upward dependency: storage/impl -> engines/harness
- **Dimension:** layering
...
| AR-0007 | P1 | layering | `src/automation/automation-router:0` | M | no |
| AR-0008 | P1 | layering | `src/engines/autonomous-execution:0` | M | no |
| AR-0009 | P1 | layering | `src/engines/capability-bootstrap:0` | M | no |
| AR-0010 | P1 | layering | `src/engines/capability-bootstrap:0` | M | no |
| AR-0011 | P1 | layering | `src/engines/capability:0` | M | no |
| AR-0012 | P1 | layering | `src/engines/cdp-capability-registrar:0` | M | no |
| AR-0013 | P1 | layering | `src/engines/chrome-governor:0` | M | no |
| AR-0014 | P1 | layering | `src/engines/config-universal-surface:0` | M | no |
...
| AR-0024 | P1 | layering | `src/engines/provider-mux:0` | M | no |
| AR-0025 | P1 | layering | `src/engines/provider-mux:0` | M | no |
| AR-0026 | P1 | layering | `src/engines/provider-mux:0` | M | no |
| AR-0027 | P1 | layering | `src/engines/provider-registrar:0` | M | no |
| AR-0028 | P1 | layering | `src/engines/send-capability:0` | M | no |
| AR-0029 | P1 | layering | `src/schema/chrome:0` | M | no |
| AR-0030 | P1 | layering | `src/schema/chrome:0` | M | no |
| AR-0031 | P1 | layering | `src/storage/contracts:0` | M | no |
| AR-0032 | P1 | layering | `src/storage/contracts:0` | M | no |
...
| AR-0037 | P1 | layering | `src/storage/db:0` | M | no |
| AR-0038 | P1 | layering | `src/storage/impl:0` | M | no |
