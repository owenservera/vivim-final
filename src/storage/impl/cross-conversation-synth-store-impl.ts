...
export class CrossConversationSynthesizerStoreImpl implements CrossConversationSynthesizerStore {
  ...
  async getFactsForConversation(conversationId: string): Promise<
    Array<{
      id: string
      subject: string
      predicate: string
  ...
  async getDecisionsForConversation(conversationId: string): Promise<
    Array<{
      id: string
      decisionText: string
  ...
  async getEntitiesForConversation(conversationId: string): Promise<
    Array<{
      id: string
      name: string
      type: string
