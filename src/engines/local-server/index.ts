...
import { LocalServerStartError } from '../../lib/tunnel-shared/errors.js'
import { getLogger } from '../../lib/tunnel-shared/logger.js'
import type { LocalServerConfig, VivimConfig } from '../../lib/tunnel-shared/types.js'
...
export class LocalServer {
  ...
  async start(): Promise<void> {
    ...
    try {
      ...
      log.info({ host: this.config.host, port: this.config.port }, 'Local server started')
    } catch (err) {
  ...
  private async handleRequest(req: Request): Promise<Response> {
    ...
    try {
      ...
      log.error({ method: req.method, path: url.pathname, err }, 'Request handling error')
