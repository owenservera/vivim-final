...
export function defaultLayerConfigs(): BudgetConfig[] {
  return [
    { layer: 'L0Identity',       minTokens: 200,  idealTokens: 1000, maxTokens: 2500,  priority: 2, elasticity: 0.3 },
    { layer: 'L1GlobalPrefs',    minTokens: 100,  idealTokens: 500,  maxTokens: 1500, priority: 3, elasticity: 0.5 },
    { layer: 'L2Topic',           minTokens: 500,  idealTokens: 3000, maxTokens: 8000, priority: 3, elasticity: 0.8 },
    { layer: 'L3Entity',          minTokens: 200,  idealTokens: 1500, maxTokens: 4000, priority: 4, elasticity: 0.7 },
    { layer: 'LpProjectState',   minTokens: 200,  idealTokens: 1500, maxTokens: 4000, priority: 4, elasticity: 0.7 },
    { layer: 'LdDecisions',      minTokens: 150,  idealTokens: 1000, maxTokens: 3000, priority: 4, elasticity: 0.6 },
    { layer: 'L4Conversation',    minTokens: 1000,idealTokens: 6000, maxTokens: 16000,priority: 1, elasticity: 0.9 },
    { layer: 'L5JitContext',      minTokens: 300,  idealTokens: 2000, maxTokens: 6000, priority: 1, elasticity: 0.6 },
    { layer: 'L6RecentHistory',   minTokens: 500,  idealTokens: 4000, maxTokens: 12000,priority: 1, elasticity: 0.8 },
    { layer: 'L7UserQuery',       minTokens: 300,  idealTokens: 1000, maxTokens: 4000, priority: 0, elasticity: 0.0 },
  ];
}
