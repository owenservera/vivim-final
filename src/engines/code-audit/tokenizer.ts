...
const KEYWORDS = new Set([
  ...
  'finally', 'throw', 'new', 'typeof', 'instanceof', 'in', 'of', 'await',
  'async', 'yield', 'import', 'export', 'from', 'extends', 'super', 'this',
  'null', 'undefined', 'true', 'false', 'delete', 'void', 'default', 'static',
  'interface', 'type', 'enum', 'namespace', 'as', 'is', 'satisfies', 'readonly',
  'implements', 'public', 'private', 'protected', 'abstract', 'get', 'set',
])
