...
import {
  ...
  P2P_DEFAULTS,
  TUNNEL_DEFAULTS,
} from '../../lib/tunnel-shared/constants.js'
import { ConfigError } from '../../lib/tunnel-shared/errors.js'
...
const DEFAULT_CONFIG: VivimConfig = {
  ...
  ledger: {
    ...
    publicKeyHex: '902b24e44284d3b156c47c10ea3e89f46c6e58ea70be23cf4d0a7f5bf25810e5',
    userToken: null,
    subdomain: null,
    userId: null,
    email: null,
...
export function loadConfig(configPath?: string): VivimConfig {
  ...
  config.localServer.port = Number.parseInt(
    process.env.VIVIM_PORT ?? String(LOCAL_SERVER_DEFAULTS.PORT),
    10,
  )
