...
import { TUNNEL_CLOSE_CODES } from '../../lib/tunnel-shared/constants.js'
import { TunnelAuthError, TunnelConnectionError } from '../../lib/tunnel-shared/errors.js'
  ...
  private startStatusReporting(): void {
    this.statusTimer = setInterval(() => {
      const frame = createStatusFrame(
        { running: true, port: 8080, requestCount: this.metrics.requestsHandled },
