...
const ROUTER_ENDPOINTS: RouterEndpoint[] = [
  ...
  {
    method: 'GET',
    path: '/api/canvas/definitions',
    slug: 'canvas_list_definitions',
    description: 'List canvas definitions',
    category: 'canvas',
  },
  {
    method: 'POST',
    path: '/api/canvas/spawn',
    slug: 'canvas_spawn',
    description: 'Spawn a new canvas instance',
    category: 'canvas',
  },
  {
    method: 'POST',
    ...
    slug: 'canvas_resolve',
    description: 'Resolve canvas nodes for a workspace',
    category: 'canvas',
  },
  {
    method: 'GET',
    ...
    slug: 'canvas_events',
    description: 'Get canvas events',
    category: 'canvas',
  },
  {
    method: 'POST',
    path: '/api/canvas/observe',
    slug: 'canvas_observe',
    description: 'Observe canvas mutations',
    category: 'canvas',
  },
  {
    method: 'GET',
    path: '/api/canvas/manifest',
    slug: 'canvas_manifest',
    description: 'Get canvas manifest',
    category: 'canvas',
  },
  {
    method: 'GET',
    path: '/api/canvas/instance/:id',
    slug: 'canvas_get_instance',
    description: 'Get a canvas instance',
    category: 'canvas',
  },
  {
    method: 'POST',
    path: '/api/canvas/instance/:id/mutate',
    slug: 'canvas_mutate_instance',
    description: 'Mutate a canvas instance',
    category: 'canvas',
  },
  {
    method: 'POST',
  ...
  // Agent Canvas
  {
    ...
    slug: 'agent_canvas_command',
    description: 'Send command to agent canvas',
    category: 'agent',
  },
  {
    method: 'GET',
    path: '/api/agent/canvas/policy',
    slug: 'agent_canvas_get_policy',
    description: 'Get agent canvas policy',
    category: 'agent',
  },
  {
    method: 'POST',
    path: '/api/agent/canvas/policy',
    slug: 'agent_canvas_set_policy',
    description: 'Set agent canvas policy',
    category: 'agent',
  },
  {
    method: 'POST',
    path: '/api/agent/canvas/plan',
    slug: 'agent_canvas_plan',
    description: 'Get agent plan for canvas',
    category: 'agent',
  },
  ...
  {
    method: 'GET',
    path: '/api/automate/recipes',
    slug: 'automation_list_recipes',
    description: 'List automation recipes',
    category: 'automation',
  },
  {
    method: 'POST',
    path: '/api/automate/run',
    slug: 'automation_run',
  ...
  {
    method: 'POST',
    path: '/api/autonomous/execute',
    slug: 'autonomous_execute',
    description: 'Execute autonomous task',
    category: 'system',
  },
  {
    method: 'GET',
    path: '/api/autonomous/tasks',
    slug: 'autonomous_list_tasks',
    description: 'List autonomous tasks',
    category: 'system',
  },
  {
    method: 'GET',
    path: '/api/autonomous/gates',
    slug: 'autonomous_gates',
    description: 'Get autonomous gates',
    category: 'system',
  },
  {
    method: 'POST',
    path: '/api/autonomous/search',
    slug: 'autonomous_search',
    description: 'Search autonomous capabilities',
    category: 'system',
  },
  ...
  {
    method: 'POST',
    path: '/api/chrome/factory',
    slug: 'chrome_create',
    description: 'Create Chrome browser instance',
    category: 'browser',
  },
  {
    method: 'POST',
    path: '/api/chrome/reset',
    slug: 'chrome_reset',
    description: 'Reset Chrome browser',
    category: 'browser',
  },
  ...
  {
    method: 'GET',
    path: '/api/conceptual/families',
    slug: 'conceptual_list_families',
    description: 'List conceptual families',
    category: 'knowledge',
  },
  {
    method: 'POST',
    path: '/api/conceptual/resolve',
    slug: 'conceptual_resolve',
    description: 'Resolve conceptual model',
    category: 'knowledge',
  },
  {
    method: 'GET',
    path: '/api/conceptual/surface',
    slug: 'conceptual_surface',
    description: 'Get conceptual surface',
    category: 'knowledge',
  },
  ...
  {
    method: 'POST',
    path: '/api/kernel/oracle/query',
    slug: 'kernel_oracle_query',
    description: 'Query kernel oracle',
    category: 'system',
  },
  {
    method: 'POST',
    path: '/api/kernel/oracle/scan',
    slug: 'kernel_oracle_scan',
    description: 'Scan kernel oracle',
    category: 'system',
  },
  {
    method: 'POST',
    path: '/api/kernel/oracle/heal',
    slug: 'kernel_oracle_heal',
    description: 'Heal via kernel oracle',
    category: 'system',
  },
  ...
  {
    method: 'POST',
    path: '/api/mutation/preview',
    slug: 'mutation_preview',
    description: 'Preview a mutation',
    category: 'system',
  },
  {
    method: 'GET',
    path: '/api/mutation/history',
    slug: 'mutation_history',
    description: 'Get mutation history',
    category: 'system',
  },
  {
    method: 'GET',
    path: '/api/mutation/status',
    slug: 'mutation_status',
    description: 'Get mutation status',
    category: 'system',
  },
  {
    method: 'POST',
    path: '/api/mutation/undo',
    slug: 'mutation_undo',
  ...
  {
    method: 'POST',
    path: '/api/mutation/redo',
    slug: 'mutation_redo',
    description: 'Redo undone mutation',
    category: 'system',
  },
  ...
  // Mux / Routing
  {
    ...
    path: '/api/route/auto',
    slug: 'route_auto',
    description: 'Auto-route a request',
    category: 'system',
  },
  {
    method: 'POST',
    path: '/api/route/mux',
    slug: 'route_mux',
    description: 'Multiplex a request',
    category: 'system',
  },
  {
    method: 'POST',
    path: '/api/route/fanout',
    slug: 'route_fanout',
  ...
  {
    method: 'GET',
    path: '/api/route/cost-report',
    slug: 'route_cost_report',
    description: 'Get routing cost report',
    category: 'system',
  },
  ...
  {
    method: 'POST',
    path: '/api/setup/workspace',
    slug: 'setup_workspace',
    description: 'Set up workspace',
    category: 'admin',
  },
  {
    method: 'POST',
    path: '/api/setup/launch-visible',
    slug: 'setup_launch',
    description: 'Launch server visibly',
    category: 'admin',
  },
  {
    method: 'POST',
  ...
  },
  {
    ...
    slug: 'storage_move',
    description: 'Move storage data',
    category: 'storage',
  },
  {
    method: 'POST',
    path: '/api/storage/rollback',
    slug: 'storage_rollback',
    description: 'Rollback storage',
    category: 'storage',
  },
  {
    method: 'POST',
  ...
  {
    method: 'POST',
    path: '/api/generative/task',
    slug: 'generative_create_task',
    description: 'Create generative task',
    category: 'ai',
  },
  {
    method: 'GET',
    path: '/api/generative/task/:id',
    slug: 'generative_get_task',
    description: 'Get generative task',
    category: 'ai',
  },
  ...
  {
    method: 'POST',
    path: '/api/harness/plan',
    slug: 'llm_harness_plan',
    description: 'Plan LLM harness execution',
    category: 'llm',
  },
  {
    method: 'POST',
    path: '/api/harness/apply',
    slug: 'llm_harness_apply',
    description: 'Apply LLM harness',
    category: 'llm',
  },
  ...
  {
    method: 'GET',
    path: '/api/provenance/weights',
    slug: 'provenance_weights',
    description: 'Get provenance weights',
    category: 'system',
  },
  ...
  {
    method: 'POST',
    path: '/api/workspace/backup',
    slug: 'workspace_backup',
    description: 'Backup workspace',
    category: 'system',
  },
  {
    method: 'POST',
    path: '/api/workspace/restore',
    slug: 'workspace_restore',
...
export function registerRouterCapabilities(
  ...
  for (const ep of ROUTER_ENDPOINTS) {
    ...
    const alreadyExists = existing.some(
      (c) => c.apiEndpoint && c.apiEndpoint.method === ep.method && c.apiEndpoint.path === ep.path,
    )
    if (alreadyExists) {
      skipped++
      continue
