...
const sample = JSON.stringify([
  {
    ...
    chat_messages: [
      { sender: 'human', text: 'Can you review this design?', created_at: '2024-01-01T00:00:01.000Z' },
      { sender: 'assistant', text: 'Sure, let me take a look.', created_at: '2024-01-01T00:00:02.000Z' },
    ],
  },
])
...
describe('ClaudeExportParserImpl', () => {
  ...
  it('parses timestamps correctly', () => {
    ...
    expect(result[0]!.messages[0]!.createdAt).toBeGreaterThan(0)
  })
})
