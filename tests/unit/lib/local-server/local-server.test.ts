...
function makeConfig(enabled = true) {
  return {
    tunnel: { enabled: false, serverUrl: '', subdomain: '', protocolVersion: '1.0', heartbeatIntervalMs: 30_000, heartbeatTimeoutMs: 10_000, reconnectInitialDelayMs: 1_000, reconnectMaxDelayMs: 60_000, reconnectJitterFactor: 0.25, maxConcurrentRequests: 50, requestTimeoutMs: 30_000, authToken: null },
    p2p: { enabled: false, bootstrapNodes: [], mdnsEnabled: false, mdnsInterval: 0, dhtEnabled: false, relayEnabled: false, maxPeers: 10, maxConcurrentTransfers: 3, maxFileSize: 104857600, identityPath: '' },
    localServer: {
      enabled,
      host: '127.0.0.1',
      port: 18080,
