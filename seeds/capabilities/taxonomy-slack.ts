...
export const SLACK_CAPABILITY_TAXONOMY = [
  ...
  },
  {
    ...
    caps: ['add_reaction', 'remove_reaction'],
  },
  {
    platformCategory: 'social_messaging',
    interactionPattern: 'thread',
    caps: ['create_thread', 'read_threads', 'reply_thread'],
  },
  {
    platformCategory: 'social_feed',
    interactionPattern: 'feed',
    caps: ['read_channels', 'read_channel_history', 'read_pinned'],
  },
  {
    platformCategory: 'social_feed',
    interactionPattern: 'mixed',
    caps: ['read_users', 'read_user_presence', 'read_user_profile'],
  },
  {
  ...
  },
  {
    ...
    caps: ['slash_command', 'open_modal', 'send_blocks'],
  },
  {
    platformCategory: 'social_messaging',
    interactionPattern: 'receive',
    caps: ['read_attachments', 'read_reactions', 'read_bookmarks'],
  },
  {
    platformCategory: 'productivity',
    interactionPattern: 'feed',
    caps: ['read_scheduled_messages', 'create_scheduled_message'],
  },
  {
    platformCategory: 'social_messaging',
    interactionPattern: 'thread',
    caps: ['read_thread_replies', 'set_topic', 'set_purpose'],
  },
].map((c) => ({
  id: ulid(),
  providerId: 'slack',
