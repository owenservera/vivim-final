...
export const NOTION_CAPABILITY_TAXONOMY = [
  {
    ...
    interactionPattern: 'document',
    caps: ['create_page', 'edit_page', 'delete_page', 'move_page', 'archive_page'],
  },
  {
    platformCategory: 'productivity',
  ...
  },
  {
    ...
    caps: ['read_page', 'read_database', 'read_page_content', 'read_database_rows'],
  },
  {
    platformCategory: 'productivity',
    interactionPattern: 'mixed',
    caps: ['create_block', 'edit_block', 'delete_block', 'append_block', 'insert_block'],
  },
  {
    platformCategory: 'social_messaging',
    interactionPattern: 'chat',
    caps: ['create_comment', 'read_comments', 'resolve_comment'],
  },
  {
    platformCategory: 'productivity',
    interactionPattern: 'feed',
    caps: ['search_pages', 'search_databases', 'search_blocks'],
  },
  {
    platformCategory: 'social_feed',
    interactionPattern: 'receive',
    caps: ['read_users', 'read_teams', 'read_spaces'],
  },
  {
    platformCategory: 'productivity',
    interactionPattern: 'mixed',
    caps: ['create_template', 'apply_template', 'read_templates'],
  },
  {
    platformCategory: 'social_messaging',
    interactionPattern: 'send',
    caps: ['invite_user', 'remove_user', 'update_permissions'],
  },
  {
    platformCategory: 'productivity',
    interactionPattern: 'thread',
    caps: ['read_page_tree', 'read_breadcrumbs', 'read_linked_pages'],
  },
].map((c) => ({
  id: ulid(),
  providerId: 'notion',
