...
export async function buildSeedBag(opts: {
	...
	for (const t of tiers) {
		await capabilityTierStore.upsertTier({
			...
			customConfigJson: t.customConfig
				? JSON.stringify(t.customConfig)
				: undefined,
		});
	}
...
export const DEFAULT_ACCOUNTS: SeedAccount[] = [
	...
	{
		id: "acct:telegram:free",
		providerId: "telegram",
		userId: "user:1",
		planTier: "free",
	},
	{
		id: "acct:whatsapp:free",
		providerId: "whatsapp",
		userId: "user:1",
		planTier: "free",
	},
	{
		id: "acct:whatsapp:pro",
		providerId: "whatsapp",
		userId: "user:1",
		planTier: "pro",
	},
	...
	{
		id: "acct:linkedin:free",
		providerId: "linkedin",
		userId: "user:1",
		planTier: "free",
	},
	{
		id: "acct:linkedin:pro",
		providerId: "linkedin",
		userId: "user:1",
		planTier: "pro",
	},
	{
		id: "acct:linkedin:trial",
		providerId: "linkedin",
		userId: "user:1",
		planTier: "trial",
	},
	{
		id: "acct:mastodon:free",
		providerId: "mastodon",
		userId: "user:1",
		planTier: "free",
	},
...
export const DEFAULT_TAXONOMIES: SeedCapabilityTaxonomy[] = [
	{
		...
		minPlanTier: "free",
		baseActions: [
			{ capabilityId: "cap:message:send", label: "Send", enabled: true },
		],
	},
	{
		...
		minPlanTier: "free",
		baseActions: [
			{ capabilityId: "cap:message:compose", label: "Compose", enabled: true },
		],
	},
	{
	...
	},
	{
		...
		baseActions: [
			{ capabilityId: "cap:export", label: "Export", enabled: true },
		],
	},
	{
...
export const DEFAULT_COMPONENTS: SeedInput[] = [
	...
	comp({
		...
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.send",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.composer",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.composer",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.thread",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.thread",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.attach",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.attach",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.streaming",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.streaming",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.header",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.header",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.actionBar",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.actionBar",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.entry",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.entry",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.bubble",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.bubble",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.result",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.result",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.confirm",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.confirm",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.sidebar",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.sidebar",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.error",
		scope: "cross-type",
		ownerId: "global",
		displayName: "cross-type:chat.error",
	}),
	...
	comp({
		...
		scope: "family",
		ownerId: "fam:ai-chat",
		displayName: "family:ai-chat:chat.bubble",
	}),
	comp({
		family: "email",
		slot: "chat.thread",
		scope: "family",
		ownerId: "fam:email",
		displayName: "family:email:chat.thread",
	}),
	comp({
		family: "messenger",
		slot: "chat.sidebar",
		scope: "family",
		ownerId: "fam:messenger",
		displayName: "family:messenger:chat.sidebar",
	}),
	comp({
		family: "social",
		slot: "chat.composer",
		scope: "family",
		ownerId: "fam:social",
		displayName: "family:social:chat.composer",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.streaming",
		scope: "family",
		ownerId: "fam:ai-chat",
		displayName: "family:ai-chat:chat.streaming",
	}),
	comp({
		family: "email",
		slot: "chat.attach",
		scope: "family",
		ownerId: "fam:email",
		displayName: "family:email:chat.attach",
	}),
	comp({
		family: "messenger",
		slot: "chat.bubble",
		scope: "family",
		ownerId: "fam:messenger",
		displayName: "family:messenger:chat.bubble",
	}),
	comp({
		family: "custom",
		slot: "chat.sidebar",
		scope: "family",
		ownerId: "fam:custom",
		displayName: "family:custom:chat.sidebar",
	}),
	comp({
		family: "messenger",
		slot: "chat.actionBar",
		scope: "family",
		ownerId: "fam:messenger",
		displayName: "family:messenger:chat.actionBar",
	}),
	...
	comp({
		...
		scope: "provider",
		ownerId: "chatgpt",
		displayName: "provider:chatgpt:chat.composer",
	}),
	comp({
		family: "email",
		slot: "chat.send",
		scope: "provider",
		ownerId: "gmail",
		displayName: "provider:gmail:chat.send",
	}),
	comp({
		family: "messenger",
		slot: "chat.thread",
		scope: "provider",
		ownerId: "slack",
		displayName: "provider:slack:chat.thread",
	}),
	comp({
		family: "social",
		slot: "chat.composer",
		scope: "provider",
		ownerId: "twitter",
		displayName: "provider:twitter:chat.composer",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.streaming",
		scope: "provider",
		ownerId: "chatgpt",
		displayName: "provider:chatgpt:chat.streaming",
	}),
	comp({
		family: "email",
		slot: "chat.attach",
		scope: "provider",
		ownerId: "gmail",
		displayName: "provider:gmail:chat.attach",
	}),
	comp({
		family: "messenger",
		slot: "chat.bubble",
		scope: "provider",
		ownerId: "whatsapp",
		displayName: "provider:whatsapp:chat.bubble",
	}),
	comp({
		family: "social",
		slot: "chat.actionBar",
		scope: "provider",
		ownerId: "linkedin",
		displayName: "provider:linkedin:chat.actionBar",
	}),
	comp({
		family: "custom",
		slot: "chat.entry",
		scope: "provider",
		ownerId: "notion",
		displayName: "provider:notion:chat.entry",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.bubble",
		scope: "provider",
		ownerId: "chatgpt",
		displayName: "provider:chatgpt:chat.bubble",
	}),
	comp({
		family: "custom",
		slot: "chat.entry",
		scope: "provider",
		ownerId: "linear",
		displayName: "provider:linear:chat.entry",
	}),
	...
	comp({
		...
		displayName: "provider+variant:chatgpt.gemini-model:chat.composer",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.streaming",
		...
		ownerId: "claude",
		variant: "opus",
		displayName: "provider+variant:claude.opus:chat.streaming",
	}),
	comp({
		family: "email",
		slot: "chat.send",
		...
		ownerId: "gmail",
		variant: "workspace",
		displayName: "provider+variant:gmail.workspace:chat.send",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.composer",
		...
		ownerId: "fam:ai-chat",
		variant: "voice",
		displayName: "family+variant:ai-chat.voice:chat.composer",
	}),
	comp({
		family: "email",
		slot: "chat.attach",
		...
		ownerId: "fam:email",
		variant: "encrypted",
		displayName: "family+variant:email.encrypted:chat.attach",
	}),
	...
	comp({
		...
		ownerId: "airtable",
		variant: "kanban",
		displayName: "provider+variant:airtable.kanban:chat.entry",
	}),
	...
	comp({
		...
		ownerId: "chatgpt",
		variant: "gemini-model",
		displayName: "provider+variant:chatgpt.gemini-model:chat.send",
	}),
	comp({
		family: "ai-chat",
		slot: "chat.send",
		...
		ownerId: "fam:ai-chat",
		variant: "voice",
		displayName: "family+variant:ai-chat.voice:chat.send",
	}),
	...
	comp({
		...
		scope: "provider",
		ownerId: "claude",
		displayName: "provider:claude:chat.bubble:deprecated",
		status: "deprecated",
	}),
	comp({
		family: "ai-chat",
		...
		scope: "provider",
		ownerId: "gemini",
		displayName: "provider:gemini:chat.streaming:draft",
		status: "draft",
	}),
];
