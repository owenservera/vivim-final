...
/**
 * components/builder/CapabilityNode.tsx
 * --------------------------------------------------------------------
 * Phase 6 — Visual Builder. A node representing a capability from the
 * CapabilityRegistry. Ports = inputs/outputs.
 *
 * CONTRACT_VERSION: 1
 */
...
export function CapabilityNode({
  ...
  return (
    ...
    >
      ...
      >
        <Icon name="bolt" size={12} style={{ color: '#f59e0b' }} />
