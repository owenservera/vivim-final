...
export type PreviewResult = { ok: true; entries: PreviewEntry[] } | { ok: false; error: string }
...
export function useMutation(opts: UseMutationOptions = {}) {
  ...
  const preview = useCallback(
    async (
      input: { plan: SurfaceMutationPlan } | { dsl: string } | { dslList: string },
